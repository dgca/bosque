...
/* harmony export (immutable) */ __webpack_exports__["default"] = bosque;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_immutable__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_immutable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_immutable__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_es6_symbol__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_es6_symbol___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_es6_symbol__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_eventemitter3__ = __webpack_require__(22);
...
function bosque() {
  let state = Object(__WEBPACK_IMPORTED_MODULE_0_immutable__["Map"])();
  let storeRegistry = Object(__WEBPACK_IMPORTED_MODULE_0_immutable__["Map"])();
  class StateEmitter extends __WEBPACK_IMPORTED_MODULE_2_eventemitter3___default.a {}
  const emitter = new StateEmitter();
  const stateChangeEvent = __WEBPACK_IMPORTED_MODULE_1_es6_symbol___default()('STATE_CHANGE_EVENT');
  ...
  function makeActions(...actions) {
    return actions.reduce((r, action) => {
      r[action] = __WEBPACK_IMPORTED_MODULE_1_es6_symbol___default()(action);
      return r;
    }, {});
  }
  ...
  class Store {
    constructor(name) {
      ...
      state = state.set(this._name, Object(__WEBPACK_IMPORTED_MODULE_0_immutable__["Map"])());
      this._subscribers = Object(__WEBPACK_IMPORTED_MODULE_0_immutable__["List"])();
    }
    ...
    setInitialData(initialData) {
      ...
      const keys = __WEBPACK_IMPORTED_MODULE_0_immutable__["Map"].isMap(initialData)
    ...
    subscribe(subscriber, func = config.defaultSubscriberFunc) {
      this._subscribers = this._subscribers.push(Object(__WEBPACK_IMPORTED_MODULE_0_immutable__["Map"])({
        subscriber,
        func
      }));
    }
...
/* harmony export (immutable) */ __webpack_exports__["makeActions"] = makeActions;

/* harmony export (immutable) */ __webpack_exports__["addStateChangeListener"] = addStateChangeListener;

/* harmony export (immutable) */ __webpack_exports__["removeStateChangeListener"] = removeStateChangeListener;
...
/* harmony export (immutable) */ __webpack_exports__["destroyStore"] = destroyStore;

/* harmony export (immutable) */ __webpack_exports__["hydrate"] = hydrate;

/* harmony export (immutable) */ __webpack_exports__["getState"] = getState;

/* harmony export (immutable) */ __webpack_exports__["configBosque"] = configBosque;
...
var d              = __webpack_require__(6)
  , validateSymbol = __webpack_require__(20)
...
var assign        = __webpack_require__(7)
  ...
  , isCallable    = __webpack_require__(16)
